...
const socialLinks = [
  ...
  {
    href: 'https://www.linkedin.com/in/silvio-fernando-rodr%C3%ADguez-chac%C3%B3n-4179a0202/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          ¡Comuníquese con nosotros hoy para discutir las necesidades de su proyecto y comencemos a trabajar en algo increíble!
          </p>
        ...
        <form action="https://getform.io/f/anlqwrpa" method="POST" className="xl:pl-10 2xl:pl-20">
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="silvio@ejemplo.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
